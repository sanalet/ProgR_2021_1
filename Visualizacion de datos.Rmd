...
ggplot(data = saber11_2019_peq, 
  ...
  geom_smooth(method = "lm") + 
  labs(title = "El puntaje de ingles es mayor", subtitle =  
       "para mayores niveles socieconomicos", x = "Nivel socioeconomico individual", y = "Puntaje Ingles en saber 11", caption = "Santiago Lopez Rodriguez")+
...
```{r}
ggplot(data = trm, mapping = aes(x = fecha_hasta, y = VALOR)) + 
  geom_line() +
