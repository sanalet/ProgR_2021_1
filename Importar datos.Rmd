...
**Antes de importar cualquier archivo usando readr, es necesario explorar el archivo en un editor de texto (i.e. Bloc de Notas o TextEdit) para saber:**
...
```{r}
personas <- read_delim("Datos/Área - Características generales (Personas).csv", delim = "|")
```
