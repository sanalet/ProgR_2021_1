...
- `group_by()` y `rowwise()` también se pueden usar para crear variables con `mutate()`. Usen `group_by()` para crear una variable que contenga el promedio del puntaje global para el municipio en el que se encuentran ubicado el colegio del estudiante:
